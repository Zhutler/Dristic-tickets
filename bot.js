...
const ADMIN_IDS = ['789355423', '7153484442', '505311483', '923046308', '723005270', '821782817']; // Впиши реальні айдішники
...
bot.start(async (ctx) => {
    ...
    ctx.reply('Вітаємо на Dristic-con! 🎫', Markup.keyboard(buttons).resize());
});
...
bot.action(/confirm_(.+)/, async (ctx) => {
    ...
    try {
        ...
        for (let i = 0; i < tx.count; i++) {
            const tId = `DRISTIC_${userId}_${Math.random().toString(36).substring(7)}`;
